    ...
    public AddressBookMainGUI(String text){
     ...
     //   frame.pack();
       ...
       /* JList names; 
        ...
        btn_add.setBackground(java.awt.Color.PINK);
        panel_btn.add(btn_add);
        
        btn_edit = new JButton("Edit");
        btn_edit.setBackground(java.awt.Color.pink);

        panel_btn.add(btn_edit);
        
        btn_delete = new JButton("Delete");
        btn_delete.setBackground(java.awt.Color.PINK);
         panel_btn.add(btn_delete);
         
        btn_search = new JButton("Search");
        btn_search.setBackground(java.awt.Color.PINK);

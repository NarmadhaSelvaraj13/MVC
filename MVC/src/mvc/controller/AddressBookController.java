    ...
    private void openAdd(){   
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
         ...
         //String name = JOptionPane.showInputDialog(detailPanel, this, Search Entries, 0);
    ...
    private void  openSearch()
    {
         ...
         if(reply.isEmpty())
         {
             JOptionPane.showMessageDialog(null,"No Search");
                     //JOptionPane.showMessageDialog("NoSearch",1);
         }
         else
         {
             daoimplement.searchPerson(reply);
             loadPersons();
         }
